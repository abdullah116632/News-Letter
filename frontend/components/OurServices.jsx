...
const OurServices = () => {
    return (
      <div className="relative z-0 mt-[-5rem] sm:mt-[-3rem] lg:mt-[-3rem] xl:mt-[-15rem] w-[100vw] h-[25rem] md:h-[76vw] bg-[url('/images/serviceDescription.png')] bg-no-repeat bg-contain">
