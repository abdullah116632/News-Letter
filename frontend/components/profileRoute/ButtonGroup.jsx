...
const ButtonGroup = () => {
  ...
  return (
    <div className="flex justify-end gap-4 my-4 lg:my-8  flex-wrap">
      ...
      <button type="button" className="bg-gradient-to-r from-pink-600 to-purple-600 hover:opacity-90 transition px-4 py-2 rounded-xl text-sm font-semibold cursor-pointer" onClick = {() => dispatch(openModal({modalName: "logout"}))}>
        LOG OUT
      </button>
    </div>
  );
